...
function create(context) {
    ...
    var ui, text, autonextIndicator, nextIndicator, returnIndicator, indicatorHint, format,
        container, screenContainer, templates, currentNode, currentSection, resources,
        createConfirm, charAnimation, notify, timerTemplate, story, vars, interpreter, screens,
        highlighter, system, settings, env, focus, confirm, nodes, bg1, bg2, bg3,
        indicatorHintTimeout, scrolling, createNotification, createRevealEffect, getClickableParent;
    ...
    function init() {
        ...
        createConfirm = context.channel("uiConfirmations/create");
        createNotification = context.channel("uiNotifications/create");
        createRevealEffect = context.channel("uiRevealEffect/create");
        getClickableParent = context.channel("domUtils/getClickableParent");
        ...
        scrolling = context.getInterface("uiScrolling", ["hideScrollbar", "scrollToBottom"]);
    ...
    function onNodeChange(node) {
        ...
        function replaceContent() {
            ...
            if (
                ...
                charAnimation = createRevealEffect(
